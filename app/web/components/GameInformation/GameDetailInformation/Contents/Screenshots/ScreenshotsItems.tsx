...
const Wrapper = styled.div(({
  ...
  max-width: ${isMobileSize ? `calc(${100 / mobileViews}% - 10px - ${30 / mobileViews}px)` : `${defaultWidth}px`};
  height: auto;
  margin: 0 5px;
  &:hover {
    cursor: pointer;
...
const ScreenshotItems = ({ itemList }: ScreenshotsProps) => {
...
export default ScreenshotItems;
